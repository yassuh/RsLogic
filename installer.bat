...
echo [*] Activate this environment and run the new control TUI:
echo     uv run rslogic-clientctl
echo [*] Or from this repo's venv directly:
echo     "%ROOT%.venv\Scripts\python.exe" -m rslogic.client.control_tui
exit /b 0
